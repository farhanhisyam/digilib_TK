                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 d-flex flex-column justify-content-center">
                                    <h1>Digital Library (DIGILIB) Teknik Telekomunikasi</h1>
                                    <h2>Politeknik Negeri Semarang (POLINES)</h2>
                                    <div>
                ...
                <section id="values" class="values">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="box">
                                    <img src="assets/img/values-1.png" class="img-fluid" alt="Data Mahasiswa">
                                    <h3>Data Mahasiswa</h3>
                                    <a href="mhstb.php"><button type="button"
                                            class="btn btn-primary"><span>Visit</span></button></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 mt-4 mt-lg-0">
                                <div class="box">
                                    ...
                                    <h3>Data Dosen</h3>
                                    <a href="dostb.php"><button type="button"
                                            class="btn btn-primary"><span>Visit</span></button></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 mt-4 mt-lg-0">
                                <div class="box">
                                    ...
                                    <h3>Data Pustaka</h3>
                                    <a href="pustb.php"><button type="button"
                                            class="btn btn-primary"><span>Visit</span></button></a>
                                </div>
                            </div>
