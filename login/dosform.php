...
<head>
    ...
    <title>Digilib - Form Dosen</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="dosform.php">Dosen</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 ms-5">Form Dosen</h1>
                    <div class="card" style="box-shadow: 0px 0 15px">
                        <div class="card-body ms-4 me-4">
                            <form action="" method="post">
                                <div class="mb-3">
                                    <label for="nip" class="form-label">NIP:</label>
                                    <input type="text" class="form-control" value="<?php echo $nip ?>"
